...
import { isObject, isString, isNumeric, templateMaker, fileHandler  } from "semantic-tailwind-core"
...
export default function generate(configObject: any, outDir:string) {
